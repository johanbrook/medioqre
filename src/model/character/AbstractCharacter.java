...
public abstract class AbstractCharacter extends Entity {
	 ...
	 * 
	 * <p>
	 * Will never make the health higher than the original max health. If the
	 * health and the amount specified are together higher than the max health,
	 * the new health will be the max health.
	 * </p>
	 * 
	 * @param amount
	 *            The amount
	...
	/**
	 * Set the health. Bypasses the maximum health, i.e. you're able to set the
	 * health higher than the maximum health.
	 * 
	 * @param amount
	 *            The new health
	 */
	...
	/**
	 * Get the maximum, or starting, health for this character as it was set on
	 * init.
	 * 
