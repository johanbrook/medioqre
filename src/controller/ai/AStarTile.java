...
public class AStarTile {
	...
	/**
	 * Specify whether this AStarTile is to be considered as a candidate for the
	 * goal.
	 * 
	 * @param value
	 */
	...
	/**
	 * Set the value of G. Will update the value of F, since it's dependant on
	 * both G and H, and H is constant throughout entire pathfinding-process.
	 * The G-value represents the length between the starting point of
	 * pathfinding and this tile.
	 * 
	 * @param g
	 */
